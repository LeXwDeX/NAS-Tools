...
[![GitHub stars](https://img.shields.io/github/stars/LeXwDeX/nas-tools?style=plastic)](https://github.com/LeXwDeX/nas-tools/stargazers)
[![GitHub forks](https://img.shields.io/github/forks/LeXwDeX/nas-tools?style=plastic)](https://github.com/LeXwDeX/nas-tools/network/members)
[![GitHub issues](https://img.shields.io/github/issues/LeXwDeX/nas-tools?style=plastic)](https://github.com/LeXwDeX/nas-tools/issues)
[![GitHub license](https://img.shields.io/github/license/LeXwDeX/nas-tools?style=plastic)](https://github.com/LeXwDeX/nas-tools/blob/master/LICENSE.md)
[![Docker pulls](https://img.shields.io/docker/pulls/LeXwDeX/nas-tools?style=plastic)](https://hub.docker.com/r/LeXwDeX/nas-tools)
[![Platform](https://img.shields.io/badge/platform-amd64/arm64-pink?style=plastic)](https://hub.docker.com/r/LeXwDeX/nas-tools)
...
[开发路线](https://github.com/LeXwDeX/nas-tools/discussions/91)
...
- [x] 持续更新索引站点
- [x] 更多功能请查阅 [版本发布](https://github.com/LeXwDeX/nas-tools/releases)  更新日志 

## 安装
### 1、Docker
```
docker pull LeXwDeX/nas-tools:latest
```
教程见 [这里](https://raw.githubusercontent.com/LeXwDeX/nas-tools/master/docker/readme.md) 。
...
```
git clone -b master https://github.com/LeXwDeX/nas-tools --recurse-submodule 
